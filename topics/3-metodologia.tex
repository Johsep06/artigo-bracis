...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{Telas/telas-plataforma.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{Telas/tela-execução.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{Telas/telas-mobile.png}
